    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('M', 'Male'), ('F', 'Female'), ('O', 'Other')], default='F', max_length=6)),
                ...
                ('verification_token_time', models.DateTimeField(default=authentication.utils.get_current_time)),
            ],
            options={
                'verbose_name': 'user',
            ...
            managers=[
                ('objects', user_crud.models.CustomUserManager()),
            ],
        ),
        migrations.CreateModel(
            name='Address',
        ...
        migrations.AddField(
            ...
            name='address',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='user_crud.Address'),
        ),
        migrations.AddField(
            model_name='customuser',
            name='groups',
